...
import {MainAdminContainer,
    ...
    MainAdminHeaderUser,
    MainAdminHeaderSearch,MainAdminContent,MainAdminAllUser,MainAdmintextfunction,MainAdminTable,MainAdminStrong,MainAdminSpan,MainAdminText,MainAdminFlex} from "./style"
function MainAdmin() {
    return (
        <MainAdminContainer>
            <MainAdminHeader>
                        ...
                        <tr>
                            <td>
                                <MainAdminFlex>
                                    ...
                                    <MainAdminSpan>updated 1 day ago</MainAdminSpan>
                                    </MainAdminText>
                                </MainAdminFlex>
                            </td>
                            <td>
