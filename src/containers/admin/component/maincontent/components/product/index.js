...
import { AiOutlineSortDescending, AiOutlineSearch } from "react-icons/ai";
...
function Product({ products, pagesProduct, token, ...action }) {
  ...
  async function handleStatusProduct(id, status) {
    ...
    const message = await apiClientPatch(
      "/admin/product_requests/update_status",
      token,
      id,
      status,
    );
              ...
              products.map((product) => (
                <tr>
                  ...
                  <td>
                    <ButtonBan
                      onClick={() =>
                        handleStatusProduct(product.id, "Rejected")
                      }
                    >
                      Rejected
                    </ButtonBan>
